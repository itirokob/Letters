...
class TutorialReference {
    ...
    let cells: [TutorialCellContent] =
        [TutorialCellContent(text: "Encontre a pegada do animal", images:
         ...
         TutorialCellContent(text: "Bata na pegada!", images: [#imageLiteral(resourceName: "tappaw01"), #imageLiteral(resourceName: "tappaw02")]),
